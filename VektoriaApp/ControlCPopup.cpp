...
void ControlCPopup::Init(CDeviceCursor* cursor, CMaterial* mat1, CWritingFont* font1)
{
	...
	m_wohnungenInsgesamt.Init(CFloatRect(0.47, 0.1, 0.1, 0.8),4,font1);
	...
	m_stromInsgesamt.Init(CFloatRect(0.47, 0.1, 0.1, 0.8), 4, font1);
	...
	m_wasserInsgesamt.Init(CFloatRect(0.47, 0.1, 0.1, 0.8), 4, font1);

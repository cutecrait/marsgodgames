...
// Der Terrain Aufbau verbraucht zu viel Speicher für 32-bit Architekturen
// Deshalb ist 32-bit nicht supported
#ifndef _M_X64
#error "64 bit architecture is required for the Terrain"
#endif // !_M_X64


constexpr float TERRAIN_SIZE = 2500.0f;
constexpr int TERRAIN_VERTICES = 1001;
